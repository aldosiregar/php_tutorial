<?php
    //array function
    /**
     * php memiliki built-in function yang digunakan untuk memanipulasi array, beberapa
     ...
     *                              (compare keys only, using a user-defined key comparison function)
     * 
     ...
     *                              the values from following arrays recursively
     * 
     ...
     *                              using a built-in function to compare the keys and a user-defined 
